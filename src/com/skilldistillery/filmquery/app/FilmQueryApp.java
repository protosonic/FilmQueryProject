...
//		app.test();
	...
	private Film returnFilmByFilmId(int filmId) { // Film return type for method chaining later
		Film film = null;
		if (filmId >= 1001) {
			System.out.println("Invalid ID provided. Try again");
	...
	private String showCategoryByFilmId(int filmId) { // String return type for method chaining later
		String category = "";
		if (filmId >= 1001) {
